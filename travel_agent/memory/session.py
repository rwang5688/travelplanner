"""Memory session manager for TravelPlanner agent."""
...
MEMORY_ID = os.getenv("MEMORY_TRAVELPLANNERMEMORY_ID")
...
def get_memory_session_manager(
    ...
    """Create a memory session manager if MEMORY_TRAVELPLANNERMEMORY_ID is set."""
    if not MEMORY_ID:
        return None
